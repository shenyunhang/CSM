...
public class MyImgFilter {
	...
	public static void main(String[] args) throws IOException {
		...
		// System.exit(1);
		// } else {
		refreshFileList("/home/syh/Downloads/touclick/");
		OutPath = "/home/syh/Downloads/touclick2/";
		for (int i = 0; i < FileList.size(); i++) {
			System.out.println("processing " + FileList.get(i));
			if (FileList.get(i).contains(".directory")) {
				continue;
			}
			...
			//flt.RemoveNoise();
			flt.saveImage(new File(FileList.get(i)).getName());
